...
/**
 * Spotlight — interactive radial glow that follows the mouse inside its parent.
 * Parent must have position:relative (set automatically by the component).
 *
 * Props:
 *   className  — extra classes for the spotlight div
 *   size       — diameter of the glow circle in px (default 200)
 *   springOptions — framer-motion spring config (default { bounce: 0 })
 */
